...
int main(){
  ...
  /*Configure settings in address struct*/	
	...
	sendto(sockfd,&a_1,4,0,(struct sockaddr *)&ta1,sizeof(ta1));
	...
	sendto(sockfd,&a_2,4,0,(struct sockaddr *)&ta2,sizeof(ta2));
	...
	sendto(sockfd,&a_3,4,0,(struct sockaddr *)&ta3,sizeof(ta3));
